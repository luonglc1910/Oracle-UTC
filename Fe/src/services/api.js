...
export const donHangApi = {
  ...
  updateStatus: (id, trang_thai) =>
    api.patch(`/donhang/${id}/trangthai`, { trang_thai }),
...
export const nhaCungCapApi = {
  ...
  getById: id => api.get(`/nhacungcap/${id}`),
  create: data => apihinhanh.post('/nhacungcap', data),
  update: (id, data) => apihinhanh.put(`/nhacungcap/${id}`, data),
