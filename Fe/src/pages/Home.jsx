    ...
    <>
      ...
      <section className='hero'>
        ...
        <h1>
          Tinh Hoa Trà Việt
          <br />
          <span>Từ Vùng Núi Thái Nguyên</span>
        </h1>
        <p>
          Thưởng thức hương vị trà ô long nguyên chất, được thu hoạch và chế
          ...
          >
            {[
              [
                '🌿',
                'Nguyên Chất 100%',
                'Trà được thu hái từ những vườn chè sạch, không hóa chất'
              ],
              [
                '🚚',
                'Giao Hàng Nhanh',
                'Giao trong 24h tại TP.Hà Nội, 2-3 ngày toàn quốc'
              ],
              [
                '✨',
                'Chất Lượng Cao',
