          ...
          {data.products
            ...
            .map(p => (
              ...
              >
                ...
                <strong
                  style={{ color: p.SO_LUONG < 5 ? '#e74c3c' : 'var(--gold)' }}
                >
                  {p.SO_LUONG}
                </strong>
              </div>
...
function ProductsTab ({ products, categories, suppliers, onRefresh }) {
  const emptyForm = {
    ten_sp: '',
    ma_danh_muc: '',
    ma_ncc: '',
  ...
  const handleImageChange = e => {
    ...
    if (!file) return
    setImageFile(file)
    setImagePreview(URL.createObjectURL(file)) // preview tức thì
  }
  ...
  const handleSave = async e => {
    ...
    setSaving(true)
    try {
      // Dùng FormData để gửi cả text lẫn file
            ...
            <div className='form-row'>
              <div className='form-group'>
                ...
                <input
                  ...
                  value={form.ten_sp}
                  onChange={e =>
                    setForm(f => ({ ...f, ten_sp: e.target.value }))
                  }
                />
              </div>
              <div className='form-group'>
                ...
                <select
                  ...
                  onChange={e =>
                    setForm(f => ({ ...f, ma_danh_muc: e.target.value }))
                  }
                >
            ...
            <div className='form-row'>
              <div className='form-group'>
                ...
                <select
                  value={form.ma_ncc}
                  onChange={e =>
                    setForm(f => ({ ...f, ma_ncc: e.target.value }))
                  }
                >
              ...
              <div className='form-group'>
                ...
                <select
                  ...
                  onChange={e =>
                    setForm(f => ({ ...f, trang_thai: e.target.value }))
                  }
                >
            ...
            <div className='form-row'>
              <div className='form-group'>
                ...
                <input
                  ...
                  value={form.gia_ban}
                  onChange={e =>
                    setForm(f => ({ ...f, gia_ban: e.target.value }))
                  }
                />
              </div>
              <div className='form-group'>
                ...
                <input
                  ...
                  value={form.gia_nhap}
                  onChange={e =>
                    setForm(f => ({ ...f, gia_nhap: e.target.value }))
                  }
                />
              </div>
            </div>
            ...
            <div className='form-row'>
              <div className='form-group'>
                ...
                <input
                  ...
                  onChange={e =>
                    setForm(f => ({ ...f, trong_luong: e.target.value }))
                  }
                />
              </div>
              <div className='form-group'>
                ...
                <input
                  ...
                  value={form.ton_kho}
                  onChange={e =>
                    setForm(f => ({ ...f, ton_kho: e.target.value }))
                  }
                />
              </div>
            </div>
...
function StatusTab ({ orders, onRefresh }) {
  ...
  const handleBulk = async nextStatus => {
    ...
    showToast(
      `✅ Đã cập nhật ${ok} đơn${fail ? ` (${fail} lỗi)` : ''} → ${
...
function StatsTab ({ stats }) {
  ...
  const maxRevenue = Math.max(
    ...(stats.revenueByMonth || []).map(r => r.DOANH_THU || 0),
    1
  )
      ...
      >
        {[
          ...
          },
          {
            ...
            label: 'Đã huỷ',
            value:
              (stats.byStatus.find(s => s.TRANG_THAI === 'huy') || {})
                .SO_LUONG || 0,
            color: '#ef4444'
          }
        ].map(k => (
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        height: pct,
                        background:
                          'linear-gradient(to top,var(--green-mid),var(--green-light))',
          ...
          {stats.byStatus.map(s => {
            ...
            return (
              <div key={s.TRANG_THAI} style={{ marginBottom: 12 }}>
                ...
                <div
                  style={{ background: '#f3f4f6', borderRadius: 4, height: 8 }}
                >
                  <div
                    style={{
                      width: `${pct}%`,
